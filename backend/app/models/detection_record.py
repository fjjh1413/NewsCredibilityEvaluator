...
class DetectionRecord(Base):
    ...
    assessment_status = Column(String(32), nullable=False, default="legacy", server_default="legacy")
    ...
    __table_args__ = (
        ...
        Index("idx_detection_user_created", "user_id", "created_at", "id"),
        Index("idx_detection_created_risk", "created_at", "risk_level"),
        Index("idx_detection_created_category", "created_at", "category"),
        Index("idx_detection_created_user", "created_at", "user_id"),
        Index("idx_detection_high_created", "is_high_risk", "created_at", "id"),
        Index(
